...
- The pre-bundled version now locks the version of [Monaco Editor](https://microsoft.github.io/monaco-editor/) to v0.55.1
...
- Magic links are now only highlighted at word boundaries in Wikitext
...
- Allow users to specify the [jsDelivr CDN](https://www.jsdelivr.com/network) when using the pre-bundled version
